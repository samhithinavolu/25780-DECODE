...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 2622.562545375553; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1923.658789341596; // x position of the perpendicular encoder (in tick units)
    }
